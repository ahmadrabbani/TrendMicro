...
class OpenurlItemWidget extends StatelessWidget {
  OpenurlItemWidget(
    this.openurlItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  OpenurlItemModel openurlItemModelObj;

  var controller = Get.find<ScannedUrlController>();
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: Obx(
              () => Text(
                openurlItemModelObj.text!.value,
